...
#define NORTHSTAR_UNCERTAINTY_X  .30 // this is the uncertainty of the northstar readings, we are providing
#define NORTHSTAR_UNCERTAINTY_Y  .30 // you with the capability to independently set the x,y,and theta
#define NORTHSTAR_UNCERTAINTY_TH .30
